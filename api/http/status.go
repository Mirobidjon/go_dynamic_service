...
var (
	...
	RoumingError = Status{
		Code:        430,
		Status:      "ROUMING_ERROR",
		Description: "Rouming bilan ulanishda xatolik",
	}
	SoliqError = Status{
		Code:        430,
		Status:      "SOLIQ_ERROR",
		Description: "my.soliq.uz bilan ulanishda xatolik",
	}
	TasnifError = Status{
		Code:        430,
		Status:      "TASNIF_ERROR",
		Description: "Tasnif bilan ulanishda xatolik",
	}
	RoumingCreate = Status{
		Code:        429,
		Status:      "ROUMING_ERROR",
		Description: "Rouming bilan ulanishda xatolik",
	}

...
```
cd existing_repo
git remote add origin https://github.com/github.com/mirobidjon/go_dynamic_service.git
git branch -M main
...
- [ ] [Set up project integrations](https://github.com/github.com/mirobidjon/go_dynamic_service/-/settings/integrations)
